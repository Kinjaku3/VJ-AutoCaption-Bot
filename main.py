...
try: app_id = int(os.environ.get("app_id", "23940021"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "8551472d7be7a223b1604e20f130548c")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "6990592306:AAHaJ5T9Whl1VCU6gum9q350OQeBsHmqlec")
...
about_message = """
<b>• Name : <a href=https://t.me/+CwBPXoIUsP82OTc9>VJ AutoCaption</a></b>
<b>• Developer : <a href=https://t.me/+CwBPXoIUsP82OTc9>[VJ UPDATES]</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/+CwBPXoIUsP82OTc9>Click Here</a></b>
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="t.me/+CwBPXoIUsP82OTc9"),
   pyrogram.types.InlineKeyboardButton("About 🤠", callback_data="about")
   ],[
   pyrogram.types.InlineKeyboardButton("➕️ Add To Your Channel ➕️", url=f"http://t.me/autocaption2000_bot?startchannel=true")
   ]]
...
print("Bot Created By https://t.me/+CwBPXoIUsP82OTc9")
